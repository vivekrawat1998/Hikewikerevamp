        ...
        <div className="my-10   font-parkinsans">
            ...
            <div className="bg-white shadow rounded-xl font-parkinsans divide-y divide-gray-200">
                {itinerary.map((day, i) => {
                    ...
                    return (
                        <div key={day.day || i} className="px-6  py-5">
                            <div
                            ...
                            >
                                <div className="flex flex-col gap-3">
                                    <span className="bg-gray-100 border border-gray-200 rounded-full md:px-4 md:py-1 text-sm font-semibold text-gray-700 w-[70px] md:w-[100px] text-center">
                                        Day {day.day}
                                    </span>
