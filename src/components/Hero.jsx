    ...
    <div className="relative w-full grid place-items-center h-screen -top-5 text-white overflow-hidden">
      ...
      <div className="absolute z-20 flex flex-col mt-20  items-center justify-center h-full w-full text-center px-4">
        ...
        <RotatingText
          ...
          mainClassName="px-2 text-3xl sm:text-4xl -mt-3  text-white lg:text-[48px] font-bold font-main  text-white overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-3xl"
          staggerFrom={"last"}
          initial={{ y: "100%" }}
          animate={{ y: 0 }}
          exit={{ y: "-120%" }}
        ...
        <p className="text-[20px] font-second font-medium  text-white mt-4">
